...
predict_lm <- function(nor_User_data, linear_model_fit) {
...
nn <- neuralnet(price~bed+bath+house_size,data=test_data,hidden=1, threshold=0.00001,act.fct=relu, rep=1, linear.output=TRUE)
