...
```{r}
load("C:/Users/MAURINE/Desktop/STA 518/RealHomePrice/tests2.RData")
```
...
```{r}
load("C:/Users/MAURINE/Desktop/STA 518/RealHomePrice/nn_model_test.RData")
load("C:/Users/MAURINE/Desktop/STA 518/RealHomePrice/lm_model_test.RData")
```


```{r}
par(mfrow=c(1,2))
plot(pricek$Actualprice,pricek$nn_predictedprice,col='red',main='Real vs predicted NN',pch=18,cex=0.7)
abline(0,1,lwd=2)
legend('bottomright',legend='NN',pch=18,col='red', bty='n')
plot(predicted_priceslm$Actualprice,predicted_priceslm$lm_predictedprices,col='blue',main='Real vs predicted lm',pch=18, cex=0.7)
abline(0,1,lwd=2)
